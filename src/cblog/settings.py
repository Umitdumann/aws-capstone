...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/umit/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/umit/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'capstone.crog2aao2kln.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'awscapstone-umit-blog' # please enter your s3 bucket name
